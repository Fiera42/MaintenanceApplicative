...
public class NewImportantEventPage implements Page {
    @Override
    public String getTitle() {
        return "Ajouter un rendez-vous prioritaire";
    }
    ...
    public void display() {
        ...
        var res = CalendarService.getInstance().addEvent(
                new ImportantEvent(title, AuthSystem.getCurrentUser(), LocalDateTime.of(year, month, day, hour, minute), duration)
        );
