...
public class MainMenu implements MenuPage {
    ...
    public Page[] getMenuItems() {
        return new Page[] {new DisplayMenu(), new NewPersonalEventPage(), new NewMeetingEventPage(), new NewPeriodicEventPage(), new NewImportantEventPage(), new RemoveEventFromIdPage(), new LogOutPage()};
    }
